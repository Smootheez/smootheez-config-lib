...
public class ConfigOption<T> {
    ...
    public static ConfigOption<Integer> ofInteger(String key, Integer defaultValue) {
        return new ConfigOption<>(key, defaultValue, Integer.class, new ConfigSerializer.IntegerSerializer());
    }

    public static ConfigOption<Float> ofFloat(String key, Float defaultValue) {
        return new ConfigOption<>(key, defaultValue, Float.class, new ConfigSerializer.FloatSerializer());
    }
    ...
    interface Callbacks<T> {
        Function<ConfigOption<T>, ClickableWidget> getWidgetCreator(ExampleConfig config, int x, int y, int width, Consumer<T> changeCallback);
    }
}